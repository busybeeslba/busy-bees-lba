...
export default function DailyRoutinesPrintView({ sheet, printOnly = false, includeGraph = true }: { sheet: any, printOnly?: boolean, includeGraph?: boolean }) {
    ...
    return (
        <div style={{
            ...
            <style>{`
                .dr-table { width: 100%; border-collapse: collapse; margin-top: 4px; }
                .dr-table thead th {
                    background: #f8fafc;
                    padding: 10px 12px;
                    text-align: center;
                ...
                .dr-table thead th.th-sto { text-align: left; }
                .dr-table thead th .day-label { font-size: 12px; font-weight: 800; color: #1e293b; display: block; }
                .dr-table thead th .day-date  { font-size: 10px; font-weight: 400; color: #64748b; display: block; margin-top: 1px; }
                .dr-table thead th .day-emp   { font-size: 10px; font-weight: 700; color: var(--primary); display: block; margin-top: 1px; }

                .dr-table tbody tr:nth-child(even) td { background: #fafbff; }
                .dr-table tbody tr:hover td { background: #f0f9ff; }

                .dr-table td { padding: 9px 12px; border: 1px solid #dde3ec; text-align: center; vertical-align: middle; }
                .dr-table td.td-num  { color: #94a3b8; font-size: 11px; font-weight: 600; width: 36px; }
                .dr-table td.td-sto  { text-align: left; font-weight: 700; font-size: 12px; color: #1e293b; }
                .dr-table td.td-pass { font-size: 18px; font-weight: 900; color: #16a34a; }
                .dr-table td.td-fail { font-size: 18px; font-weight: 900; color: #dc2626; }
                .dr-table td.td-nil  { font-size: 16px; color: #d1d5db; }
                .dr-table td.td-total{ white-space: nowrap; font-size: 11px; }

                .dr-table tfoot tr td {
                    background: #f1f5f9;
                ...
                .dr-table tfoot td.ft-label { text-align: left; color: #475569; font-size: 11px; }
                .dr-table tfoot td.ft-data  { text-align: center; white-space: nowrap; }
                ...
                @media print {
                    .dr-table thead th, .dr-table tfoot td, .dr-table tbody tr:nth-child(even) td, .dr-table tbody tr:hover td {
